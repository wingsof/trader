...
_TRADECONDITION = _descriptor.Descriptor(
  name='TradeCondition',
  full_name='stock_api.TradeCondition',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='is_buy', full_name='stock_api.TradeCondition.is_buy', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='strategy', full_name='stock_api.TradeCondition.strategy', index=1,
...
_TRADEMSG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='price', full_name='stock_api.TradeMsg.price', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quantity', full_name='stock_api.TradeMsg.quantity', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='percentage', full_name='stock_api.TradeMsg.percentage', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='conditions', full_name='stock_api.TradeMsg.conditions', index=3,
...
_TRADEMSG.fields_by_name['conditions'].message_type = _TRADECONDITION
...
DESCRIPTOR.message_types_by_name['TradeCondition'] = _TRADECONDITION
...
TradeCondition = _reflection.GeneratedProtocolMessageType('TradeCondition', (_message.Message,), {
  'DESCRIPTOR' : _TRADECONDITION,
  '__module__' : 'stock_provider_pb2'
  # @@protoc_insertion_point(class_scope:stock_api.TradeCondition)
  })
_sym_db.RegisterMessage(TradeCondition)
...
_STOCK = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='RequestOrder',
    full_name='stock_api.Stock.RequestOrder',
    index=7,
    containing_service=None,
