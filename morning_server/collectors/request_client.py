...
def request_trade_handler(sock, header, body):
    pass
...
def dispatch_message(sock):
    stream_readwriter.dispatch_message(sock, request_handler=request_handler, 
                                        subscribe_handler=handle_stock_subscribe, 
                                        request_trade_handler=request_trade_handler)
