...
Stock::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_RequestCybosAlarm_(Stock_method_names[12], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RequestToTrader_(Stock_method_names[13], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RequestCybosTradeResult_(Stock_method_names[14], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ReportOrderResult_(Stock_method_names[15], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_IsKospi_(Stock_method_names[16], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetViPrice_(Stock_method_names[17], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListenTraderMsg_(Stock_method_names[18], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCybosOrderResult_(Stock_method_names[19], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenOrderResult_(Stock_method_names[20], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  ...
  , rpcmethod_GetViList_(Stock_method_names[34], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListenCurrentStock_(Stock_method_names[35], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenListChanged_(Stock_method_names[36], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCybosTickData_(Stock_method_names[37], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCybosBidAsk_(Stock_method_names[38], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCurrentTime_(Stock_method_names[39], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
