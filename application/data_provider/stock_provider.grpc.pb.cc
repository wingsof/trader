...
Stock::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_OrderStock_(Stock_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ChangeOrder_(Stock_method_names[7], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CancelOrder_(Stock_method_names[8], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RequestCybosTickData_(Stock_method_names[9], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RequestCybosBidAsk_(Stock_method_names[10], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RequestCybosSubject_(Stock_method_names[11], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RequestToTrader_(Stock_method_names[12], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RequestCybosTradeResult_(Stock_method_names[13], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ReportOrderResult_(Stock_method_names[14], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_IsKospi_(Stock_method_names[15], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetViPrice_(Stock_method_names[16], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListenTraderMsg_(Stock_method_names[17], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCybosOrderResult_(Stock_method_names[18], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenOrderResult_(Stock_method_names[19], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_SetCurrentStock_(Stock_method_names[20], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SetCurrentDateTime_(Stock_method_names[21], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetCompanyName_(Stock_method_names[22], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SetSimulationStatus_(Stock_method_names[23], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetSimulationStatus_(Stock_method_names[24], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  ...
  , rpcmethod_GetTodayTopAmountList_(Stock_method_names[30], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetTodayNineThirtyList_(Stock_method_names[31], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetRecentSearch_(Stock_method_names[32], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetViList_(Stock_method_names[33], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListenCurrentStock_(Stock_method_names[34], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenListChanged_(Stock_method_names[35], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCybosTickData_(Stock_method_names[36], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCybosBidAsk_(Stock_method_names[37], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCurrentTime_(Stock_method_names[38], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCybosSubject_(Stock_method_names[39], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenCybosAlarm_(Stock_method_names[40], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ListenSimulationStatusChanged_(Stock_method_names[41], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_StartSimulation_(Stock_method_names[42], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_StopSimulation_(Stock_method_names[43], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
