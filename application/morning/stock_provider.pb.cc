...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_stock_5fprovider_2eproto[6];
...
::PROTOBUF_NAMESPACE_ID::uint8* CybosTickData::_InternalSerialize(
  ...
  if (this->volume() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(17, this->_internal_volume(), target);
  }
