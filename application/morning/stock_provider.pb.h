...
inline ::PROTOBUF_NAMESPACE_ID::uint64 CybosTickData::_internal_volume() const {
  return volume_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 CybosTickData::volume() const {
  // @@protoc_insertion_point(field_get:stock_api.CybosTickData.volume)
  return _internal_volume();
}
inline void CybosTickData::_internal_set_volume(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  volume_ = value;
}
inline void CybosTickData::set_volume(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_volume(value);
